    ...
    async execute(interaction, client, message) {
        ...
        const e = new Discord.EmbedBuilder()
            ...
            .addFields(
                ...
                { name: `<:topggAngry:1026468391709577226> Desarrollador`, value: `\`\`\`yml\nName: wilyrex. \nID: [1134180468594585692]\`\`\``},
                { name: `<:panda_gift:1007529203119439882> Probador - Co-Owner`, value: `\`\`\`yml\nName: noe_borro_sucuenta\nID: [1194268581047840792]\`\`\``},
                { name: `<a:InLove:1006999906969469019> Links Importantes`, value: `[**・Invitacion del Bot**](https://discord.com/api/oauth2/authorize?client_id=1170181516878430269&permissions=0&scope=bot) [**・ Invitacion a Soporte**](https://discord.gg/sDGJW5wDEW) [**・ Pagina Web Oficial**](https://cactus.com/inicio/)` }
            );
